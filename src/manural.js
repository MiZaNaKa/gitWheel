...
class App extends React.Component {
  ...
  renderWheel() {
    ...
    let numOptions = this.state.pickerValue.length;
    ...
    for (let i = 0; i < numOptions; i++) {
      let text = this.state.pickerValue[i];
      ...
      <div className="App">
        ...
        <div className='content clearfix'>
          ...
          <div class="display">
            <span id="readout">
              YOU WON:{"  "}
              <span id="result">{this.state.pickerValue[this.state.result]}</span>
            </span>
          </div>
          </div>
